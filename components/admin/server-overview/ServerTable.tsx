...
type SortField = "name" | "member_count" | "sc_user_count" | "total_credits" | "total_xp" | "created_at";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm text-muted-foreground">
            {filteredAndSortedServers.length} server{filteredAndSortedServers.length !== 1 ? 's' : ''}
          </span>
        </div>
      </div>
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Search servers by name, owner, or features..."
                ...
                <div className="p-4">
                  ...
                  <div className="md:hidden mt-4 grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>{server.sc_user_count.toLocaleString()} SC Users</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Coins className="h-4 w-4 text-muted-foreground" />
                      <span>{server.total_credits.toLocaleString()} Credits</span>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <CollapsibleContent>
                  <div className="border-t border-border bg-muted/30 p-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {/* Server Details */}
                      <div>
                        <h4 className="font-medium text-foreground mb-3">Server Details</h4>
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className={`font-medium ${server.is_active ? 'text-green-600' : 'text-red-600'}`}>
