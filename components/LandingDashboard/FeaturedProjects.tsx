                ...
                <div key={slideIndex} className="w-full flex-shrink-0 flex">
                  {projects
                    ...
                    .map((project) => (
                      ...
                      >
                        <div className="group relative bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 rounded-xl sm:rounded-2xl p-4 sm:p-6 hover:border-blue-300/50 dark:hover:border-blue-600/50 hover:shadow-2xl transition-all duration-300 hover:scale-105 h-full hover:z-10">
        ...
        <div className="flex items-center justify-center space-x-4 sm:space-x-6 mt-6 sm:mt-8">
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className="p-2 sm:p-3 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 hover:scale-110"
            >
